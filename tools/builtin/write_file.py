...
class WriteFileParams(BaseModel):
    path : str = Field(..., description="Path of the file to write, (relative to working directory or absolute)")
    ...
    async def execute(self, invocation: ToolInvocation) -> ToolResult:
        ...
        try:
            if params.create_directories:
                ...
                return ToolResult.error_result(f"Parent directory doesnot exits: {path.parent}")
